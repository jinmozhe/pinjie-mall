import type {
  ...
  ProductCreate, ProductDetailRead, ProductRead, ProductStatusBatch, ProductStatusUpdate, ProductUpdate,
...
export const commerceApi = {
  ...
  product: (id: string) => apiRequest<ProductDetailRead>(`/api/v1/admin/products/${id}`),
