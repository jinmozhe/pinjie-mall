export default [
  ...
  },
  {
    ...
    access: "canFinance",
    routes: [
      { path: "/finance", redirect: "/trade/payments" },
      { path: "/trade/payments", name: "支付记录", component: "../features/trade/PaymentsPage", access: "canPayments" },
      { path: "/distribution/wallets", name: "钱包管理", component: "../features/distribution/WalletsPage", access: "canWallets" },
      { path: "/distribution/withdrawals", name: "提现管理", component: "../features/distribution/WithdrawalsPage", access: "canWithdrawals" },
      { path: "/trade/reconciliation", name: "资金对账", component: "../features/trade/ReconciliationPage", access: "canReconciliation" },
    ],
  },
  {
    path: "/system-mgmt",
