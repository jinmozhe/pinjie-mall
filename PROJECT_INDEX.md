...
| 项目类型 | 独立商城仓库 |
| 当前阶段 | 后端阶段 1 至 6、会员资格与积分及 2026-09-23 符合性修复已有本地实现；本机开发库和隔离测试库已升级至 `20260923_02`，完整 Backend pytest、迁移、恢复及结构检查通过；Admin 已有交易查询、接单和对账处置等部分入口，新模型适配未全部完成；小程序未实施，Web 永久冻结 |
...
| 计划 | 状态 | 当前范围 |
| --- | --- | --- |
| [Admin 管理端全栈实施计划](plans/2026-09-23_Admin管理端全栈实施计划.md) | 实施中 | 8 个一级分组、29 个二级菜单及配套后端查询、批量能力与权限；P0 与 P1 已完成，待推进 P2 商品中心与库存管理 |
