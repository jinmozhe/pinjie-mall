...
| 项目类型 | 独立商城仓库 |
| 当前阶段 | 客户端形态确立为微信小程序，不需要 Web 端；商城后端 M1 商品基础与 M2 交易基础已完成本地实现，后续按四阶段计划推进；管理后台页面与小程序端不在本轮实现范围 |
...
| 计划 | 状态 | 当前工作 |
| --- | --- | --- |
| [商城后端四阶段建设计划](plans/2026-09-17_商城后端四阶段建设计划.md) | 实施中 | M0、M1、M2 已完成本地交付，M3 支付售后与 M4 分销尚未实施 |
