...
| 路径 | 状态 | 结果 | 影响范围 | 用途 |
| --- | --- | --- | --- | --- |
| `plans/2026-09-23_后端数据规划符合性分阶段修复计划.md` | 实施中 | 不适用 | Backend、Admin、Database、API Client、Documentation | 阶段 A 至 F 已完成本地实现；阶段 F 建立成交消费资格贡献与整单退款冲销；有效邀请触发规则未定义，实际迁移和动态验证未执行 |
