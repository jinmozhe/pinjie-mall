...
| 路径 | 状态 | 结果 | 影响范围 | 用途 |
| --- | --- | --- | --- | --- |
| `plans/2026-09-23_后端数据规划符合性分阶段修复计划.md` | 实施中 | 不适用 | Backend、Admin、Database、API Client、Documentation | 阶段 A 至 E 已完成本地实现；阶段 E 建立财务归属约束、提现全生命周期审计和对账差异版本化处置；F 继续跟踪，实际迁移和动态验证未执行 |
